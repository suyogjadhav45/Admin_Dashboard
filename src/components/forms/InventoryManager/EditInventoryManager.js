        ...
        <>
            <div className="container">
                <div className="main m-0 p-0 bg-tailtertiary">
                    ...
                    <Navbar pagename="Edit Inventory Manager Page" pagenumber="115" />
                        ...
                        <div style={{ width: "800px" }} className='mt-4 bg-white border border-2 rounded-md resize-x mx-auto flex shadow-[0_20px_50px_rgba(8,_100,_150,_0.5)]'>
                            ...
                            <form className='w-full mx-auto bg-white p-4' onSubmit={handleSubmit}>
                                ...
                                <div className='flex mx-auto mt-2'>
                                    ...
                                    <button className='m-2 font-poppins font-bold border w-full mt-2 mb-2 rounded-md py-2 bg-tailtertiary3 hover:bg-red-600 text-black' onClick={() => navigate('/dashboard/viewinventorymanagers')}>DISCARD</button>
                                </div>
                                <div>
