        ...
        <>
            <div className="container">
                <div className="main m-0 p-0 bg-tailtertiary">
                    ...
                    <Navbar pagename="Add Finance Manager Page" pagenumber="116" />
                        ...
                        <div style={{ width: "800px" }} className='mt-4 bg-white border border-2 rounded-md resize-x mx-auto flex shadow-[0_20px_50px_rgba(8,_100,_150,_0.5)]'>
                            ...
                            <form className='w-full mx-auto bg-white p-4' onSubmit={handleSubmit}>
                                ...
                                <div className='flex flex-col py-2'>
                                    ...
                                    <input value={values.firstname} autoComplete="off" className='mt-1 border p-2 rounded-md' type="name" name='firstname' placeholder='Enter First Name' onBlur={handleBlur} onChange={handleChange} />
                                ...
                                <div className='flex flex-col py-2'>
                                    ...
                                    <input value={values.contact} required className='mt-1 border p-2 rounded-md' type="tel" name='contact' placeholder='Enter Contact Number' onBlur={handleBlur} onChange={handleChange} />
